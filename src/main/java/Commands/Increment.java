...
public class Increment implements Command {
    ...
    public static List<Command> concurrents;
    ...
    public HashMap<String, Expr> applyEffect(HashMap<String, Expr> state, Context ctx) {
        ...
        hashMap1.put(key, (IntExpr) ctx.mkAdd(new ArithExpr[]{(IntExpr) x, ctx.mkInt(1)}));
        return hashMap1;
    }
